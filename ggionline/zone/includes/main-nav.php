      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo DOMAIN; ?>">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active" href="<?php echo DOMAIN; ?>applications/" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Applications</a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="<?php echo DOMAIN; ?>applications/new-students.php">New Student</a>
              <a class="dropdown-item" href="<?php echo DOMAIN; ?>applications/dpr.php">DPR</a>
            </div>
          </li>
          <li class="nav-item">
