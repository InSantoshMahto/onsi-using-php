    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <img src="<?php echo DOMAIN; ?>resources/images/user.png" class="rounded" alt="User">
        </div><!-- text-center for ### image-center ### --><br /><br />
        <div class="row">

          <div class="col">

            <span><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo ucfirst($profileRow['firstName'])." ".ucfirst($profileRow['middleName'])." ".ucfirst($profileRow['lastName']); ?>
            </span>
          ...
          <div class="col">
            ...
            <span><?php echo ucfirst($profileRow['access']); ?> : Admin/Marketing</span>
        ...
        <div class="profileModelAjax">
          ...
          <?php /*  including profile update  for updating user details  */ include 'update-model.php'; ?>
