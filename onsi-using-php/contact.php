...
<html lang="en-IN">
  <head>
   ...
   <!-- <meta http-equiv="refresh" content="30">  -->
    ...
    <title>Contact - One Not Software Info</title>
...
================================================== -->
  <body>
    ...
    <section style="margin-top: 80px;">
    	<h1 align="center" style="color: #aa44ee;">Contact</h1>
    	<blockquote style="text-align: center; color: #ffffff; font-family: tahoma; background: #000000;">
    		<br>Santosh Mahto <br><br>
    		Mobile :- +919430141605<br><br>
    		E-mail :- onsihero@gmail.com<br><br>
    	</blockquote>
    </section>
    <div>
